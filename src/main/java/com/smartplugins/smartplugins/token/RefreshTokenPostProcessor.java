...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
    ...
    public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body,
        ...
        adicionarCookie(refreshToken, req, resp);
    ...
    private void adicionarCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
        Cookie refreshCookie = new Cookie("refreshToken", refreshToken);
        refreshCookie.setHttpOnly(true);
        refreshCookie.setSecure(false); //mudar para true em produção
